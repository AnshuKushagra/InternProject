    ...
    <>
      {/* <div className="bg-gray-100 flex justify-end">
        <button
          ...
          className="bg-red-500 text-white px-4 py-2 rounded-lg font-medium hover:bg-red-600 transition duration-300 mx-10 mt-3 "
        >
          Logout
        </button>
      </div> */}
        ...
        <div className="flex flex-col md:flex-row gap-6 w-full max-w-4xl">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-full md:w-1/2">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold text-center">Add New Agent</h3>
              <button
                className="bg-gray-500 text-white px-4 py-2 rounded-lg font-medium hover:bg-gray-600 transition duration-300"
                onClick={handleViewAllAgents} // Define this function
              >
                View All Agents
              </button>
            </div>
